<template>
  <div class="modal fade" id="editForm" tabindex="-1" aria-labelledby="groupFormLabel" aria-hidden="true">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mt-3 inputBox">
                  ...
                  <input type="text" class="bg-grey text-dark" v-model="editable.name" required aria-required="true" />
                </div>
              </div>
            </div>
