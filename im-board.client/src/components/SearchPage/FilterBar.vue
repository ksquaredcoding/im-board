<template>
 ...
 -->
  ...
  <div class="d-flex align-items-center mx-4">
    ...
    <select v-model="editable" class="form-select bg-transparent border-0 text-light button-52"
      aria-label="Default select example" @click="searchByPlayerCount()">
  ...
  <div class="d-flex align-items-center">
    ...
    <select v-model="editable" class="form-select bg-transparent border-0 text-light button-52"
      aria-label="Default select example" @click="searchByPlayTime()">
  ...
  <div class="dropdown bg-transparent ms-4">
    <button type="button" class="btn dropdown-toggle button-52" data-bs-toggle="dropdown" aria-expanded="false"
    ...
    <form class="dropdown-menu px-2" @submit.prevent="searchByYear()">
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="minYear" v-model="editable" min="1950" max="9999">
      </div>
